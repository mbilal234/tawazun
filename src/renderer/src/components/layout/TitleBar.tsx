...
export default function TitleBar() {
  return (
    <div className="drag h-12 flex items-center justify-between bg-surface-0 border-b border-surface-3 flex-shrink-0 z-50">
      <div className="pl-3 flex items-center gap-2 select-none">
        <img src={logo} alt="Tawazun" className="h-10 w-10 object-contain" />
